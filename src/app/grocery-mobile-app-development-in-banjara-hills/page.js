...
export const metadata = {
    title:
        "Grocery Mobile App Development in Banjara Hills | Dexterous Technology",
    description:
        "Dexterous Technology specializes in grocery mobile app development in Banjara Hills. We create user-friendly and feature-rich apps tailored to your needs.",
    keywords:
        "Grocery Mobile App Development, Banjara Hills, Dexterous Technology, App Development Services",


    openGraph: {
        title: 'Grocery Mobile App Development In Banjara Hills | Dexterous Technology', // OG Title
        description: 'Dexterous Technology specializes in grocery mobile app development in Banjara Hills. We create user-friendly and feature-rich apps tailored to your needs.', // OG Description
        url: 'https://dexterous.in/grocery-mobile-app-development-in-banjara-hills', // OG URL
...
const GroceryMobileAppDevelopmentInBanjaraHills = (props) => {
    return (
        <>
...
export default GroceryMobileAppDevelopmentInBanjaraHills;