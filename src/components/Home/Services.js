          ...
          <div className="col-lg-3 col-md-6 col-sm-12">
            <div className="ser-bg1">
              <div className="p-md-5 p-3">
                ...
                <p>
                  We provide the best web & mobile app development services form
          ...
          <div className="col-lg-3 col-md-6 col-sm-12 mt-md-0 mt-4">
            <div className="ser-bg2">
              <div className="p-md-5 p-3">
                ...
                <p>
                  Our dedicated team of eCommerce experts supports businesses to
                  build customer-centric eStores.
                </p>
              </div>
            </div>
          </div>
